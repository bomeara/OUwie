...
In the appendix on page 2383 when it describes the covariation under an OU_MVA model, the final term is __latex___ when it should be ___latex___, as it is correctly written in equation A.26.
